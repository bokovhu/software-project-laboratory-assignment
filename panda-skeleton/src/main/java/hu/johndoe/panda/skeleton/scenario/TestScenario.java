...
public class TestScenario {
    ...
    public static final List <TestScenario> SCENARIOS = Arrays.asList (
            ...
            new TestScenario("Orangutan steps",
                                         () -> {
        ...
        orangutan.moveTo (tile1);
            ...
            new TestScenario("Orangutan steps with pandas",
                    () -> {
            ...
            new TestScenario("Orangutan grabs first panda",
                    () -> {
            ...
            new TestScenario("Orangutan grabs another panda",
                    () -> {
            ...
            new TestScenario("Panda gets scared in line",
                    () -> {
            ...
            new TestScenario("Panda gets scared alone",
                    () -> {
            ...
            new TestScenario("Orangutan leads pandas out",
                    () -> {
            ...
            new TestScenario("Panda falls down alone",
                    () -> {
            ...
            new TestScenario("Panda falls down in line",
                    () -> {
            ...
            new TestScenario("Orangutan falls down",
                    () -> {
            ...
            new TestScenario("Panda sleeps alone",
                    () -> {
            ...
            new TestScenario("Panda jumps alone",
                    () -> {
            ...
            new TestScenario("Panda sleeps in line",
                    () -> {
            ...
            new TestScenario("Panda jumps in line",
                    () -> {
            ...
            new TestScenario("Panda collides with panda",
                    () -> {
